function selectRate(loanType, a) {
    if (loanType === "30yr_fixed")
        return { rate: a.interestRate30yr, years: 30 };
    if (loanType === "15yr_fixed")
        return { rate: a.interestRate15yr, years: 15 };
...
export function computeMetrics(deal, a) {
